...
import it.unibo.almarima.tablut.application.heuristics.WeightedHeuristic.KingEscaped;
import it.unibo.almarima.tablut.application.heuristics.WeightedHeuristic.WeightedHeuristic;
...
public class ImplPlayer extends TablutPlayer{
	...
	long timeLimit = (this.getTimeout()-55)*1000;
